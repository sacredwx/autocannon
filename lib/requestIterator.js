...
RequestIterator.prototype.rebuildRequests = function () {
  this.requests.forEach((request) => {
    [ request.requestBuffer, request.url ] = this.requestBuilder(request)
  })
}
...
RequestIterator.prototype.rebuildRequest = function () {
  [ this.currentRequest.requestBuffer, this.currentRequest.url ] = this.requestBuilder(this.currentRequest)
